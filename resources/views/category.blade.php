<x-layout>
    ...
    <section class="flex min-h-[30rem] w-full mt-5 text-base mb-8">
        <div class="flex mx-auto w-full max-w-[70rem]">
            ...
            <section id="main-content" class="w-full border-t-[1px]  max-w-[60rem]">
                <section class="mb-2">
    ...
    <script>
        ...
        @if (isset($subcategory))
            phpSubcategory = {{ Illuminate\Support\Js::from($subcategory) }};
        @endif
        @if (isset($building))
